      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-surface border border-border rounded-xl p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            {error && (
              <p className="text-xs text-danger bg-danger-bg rounded-lg px-3 py-2">{error}</p>
            )}
            {message && (
              <p className="text-xs text-success bg-success-bg rounded-lg px-3 py-2">{message}</p>
            )}
